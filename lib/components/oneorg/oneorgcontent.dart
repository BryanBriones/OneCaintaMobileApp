...
class OneOrgContentWidget extends StatefulWidget {
final String govOfficialDesc;
OneOrgContentWidget(this.govOfficialDesc);
 @override
  _OneOrgContentWidgetState createState() => _OneOrgContentWidgetState(this.govOfficialDesc);
}

class _OneOrgContentWidgetState extends State<OneOrgContentWidget>{

 String govOfficialDesc;
_OneOrgContentWidgetState(this.govOfficialDesc);
