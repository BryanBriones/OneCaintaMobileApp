...
NewsContentWidget(this.newsbody);
 @override
  _NewsContentWidgetState createState() => _NewsContentWidgetState(this.newsbody);
}
...
String headline;
String date;
_NewsContentWidgetState(this.newsbody);
            ...
            Expanded(child:Material( 
                     ...
                     crossAxisAlignment: CrossAxisAlignment.start ,
                          children:[
                            ...
                            //   )
                            Padding(padding: EdgeInsets.fromLTRB(10, 10, 10, 10), child:Text(newsbody.replaceAll(r'\n', '\n')))
