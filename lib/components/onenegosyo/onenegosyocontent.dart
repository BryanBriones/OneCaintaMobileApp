...
class OneNegosyoContentWidget extends StatefulWidget {

 final String businessdesc;

OneNegosyoContentWidget(this.businessdesc);
 @override
  _OneNegosyoContentWidgetState createState() => _OneNegosyoContentWidgetState(this.businessdesc);
}

class _OneNegosyoContentWidgetState extends State<OneNegosyoContentWidget>{

String businessdesc;

_OneNegosyoContentWidgetState(this.businessdesc);
