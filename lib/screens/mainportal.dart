...
class MainPortal extends StatelessWidget{
    ...
    List<String> menus = ["Announcements", "One Cainta Pass", "One Services", "One Donation", "One Negosyo","One Organization", "COVID-19 Vaccine", "Waste Management", "Job Openings", "Policies", "Calendar",  "Contact Us"];
